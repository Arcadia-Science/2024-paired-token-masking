...
Now, install any internal or external packages in the repository:

```bash
make install
```

To make getcontacts available in this first session:
```bash
source ~/.bashrc
conda activate {{< var pub.repo >}}
```
